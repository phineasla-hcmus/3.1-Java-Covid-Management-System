...
public class StatisticNumberChangeStatusController {
    ...
    private void handleButton(ActionEvent e) throws IOException {
        if (e.getSource() == nextButton) { // để đổi bảng thống kê th , ko cần qtam:))
            ...
            //sẽ dựa vào ngày để thống kê số lượng chuyển trạng thái theo ngày trong database và hiển thị trong bảng 
            //+ tổng các F0 khỏi bệnh sẽ được hiển thị ở Label totalCured
            totalCured.setText("0");
