        ...
        btnChangeCapacity.setOnAction(event -> {
            ...
            if (result.isPresent()) {
                if (result.get().equals("")) {
                    ...
                    Alert.showAlert(AlertType.WARNING, "Cập nhật thông tin địa điểm điều trị/cách ly", "Sức chứa của địa điểm điều trị/cách ly không được nhỏ hơn số lượng tiếp nhận hiện tại");
